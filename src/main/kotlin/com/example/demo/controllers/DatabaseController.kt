...
@RestController
@RequestMapping("/db")
class DatabaseController(val db: JdbcTemplate) {

    @GetMapping("/populate")
    suspend fun populateDatabase() {        val sql = """
...
//        databaseRepository.populateDatabase()
    }
    ...
    suspend fun cleanDatabase() {
        ...
        """.trimIndent()
//        return db.execute(sql)   databaseRepository.cleanDatabase()
    }
}
